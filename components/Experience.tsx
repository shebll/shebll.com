  ...
  return (
    <section ref={refSection} id="experience" className="flex flex-col justify-center items-center gap-12 scroll-m-28">
      <div className="flex justify-center items-center flex-col gap-3 ">
        ...
        <h1 className='subText'>My All Experience Over one single year .</h1>
      </div>
      <div className="hidden lg:block ">
        {experiencesData.map((item,index)=>(
          <div key={index} className="cardExperience group w-1 h-56 bg-black/5 relative flex justify-center dark:bg-gray-50 ">
            ...
            group-even:right-12 dark:bg-[#17181c]
              ...
              <p className="text-lg font-medium text-gray-500 dark:text-gray-300">{item.description}</p>
