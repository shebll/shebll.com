...
function Resume() {
  const {refSection} =useActiveSectionInView({sectionName:"Resume" ,amount:0.1})
  ...
  return (
    <section id='resume' className='resumeSection relative' ref={refSection}>
      <motion.div className="cv z-10 relative hidden md:block"
        ref={refImg2}
        style={{scale:scale,translateY:transform }} 
      >
        <div className="front z-20 relative"
        
        >
          <Image src={"/personalImages/1.jpeg"} alt='1Resume image' width={900} height={700} quality={92}/>
        </div>
        <div className="subCv dark:bg-[#111827] bg-[#f9fafb] z-10 relative">
        <motion.div
          className="middle origin-top  "
          style={{ rotateX: transformZ2  }}
          ref={refImg3}
          >
          <Image src={"/personalImages/2.jpeg"} alt='1Resume image' width={900} height={700} quality={92}/>
        </motion.div>          
        </div>
        <motion.div className="final z-0 origin-top relative"
          style={{rotateX: transformZ3  }}>
          <Image src={"/personalImages/3.jpeg"} alt='1Resume image' width={900} height={700} quality={92}/>
        </motion.div>
      </motion.div>
      <div className="block md:hidden">
        <Image src={"/personalImages/Ahmed_ResumeH.jpg"} alt='1Resume image' width={900} height={700} quality={92}/>      
      </div>
